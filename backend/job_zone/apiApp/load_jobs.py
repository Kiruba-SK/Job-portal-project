...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'job_zone.settings')
django.setup()

from django.utils import timezone
from apiApp.models import Job, Company
...
jobs = [
    {
        ...
        'companyId': {
            ...
            "image": "company/company_icon.svg",
        },
        'description': """
        <p>We are seeking a highly skilled Full Stack Developer to join our dynamic and innovative team. The ideal candi'date' will have a passion for developing scalable web applications and working across the entire technology stack, including front-end and back-end development. You will have the opportunity to work with the latest technologies and contribute to exciting projects that impact our users directly.</p>
    ...
    },
    {
        ...
        <ol>
            ...
            <li>Stay up'date'd with industry trends and best practices in UI/UX design.</li>
    ...
    },
    {
        ...
        <ol>
            ...
            <li>Document network configurations and maintain up'date'd records.</li>
    ...
    },
    {
        ...
        <ol>
            ...
            <li>Stay up'date'd on emerging cloud technologies and industry trends.</li>
        </ol>
        <h2><strong>Skills Required</strong></h2>
        <ol>
    ...
    },
    {
        ...
        <ol>
            ...
            <li>Ensure that documentation is up-to-'date' and consistent with product up'date's.</li>
    ...
    },
    {
        ...
        <ol>
            ...
            <li>Stay up'date'd on design trends and best practices in UX/UI.</li>
        </ol>
        <h2><strong>Skills Required</strong></h2>
        <ol>
    ...
    },
    {
        ...
        <h2><strong>Key Responsibilities</strong></h2>
        <ol>
            <li>Assist with the recruitment process, including job postings and candi'date' screenings.</li>
    ...
    },
    {
        ...
        <ol>
            ...
            <li>Stay up'date'd on design trends and tools to continually enhance skills and creativity.</li>
    ...
    },
    {
        ...
        <ol>
            ...
            <li>Stay up'date'd on the latest security trends and technologies.</li>
        </ol>
        <h2><strong>Skills Required</strong></h2>
        <ol>
